...
def votingPg(root, frame1, client_socket):
    ...
    Radiobutton(
        ...
        height=4,
        width=15,
        command=lambda: voteCast(root, frame1, "Student council", client_socket),
    ).grid(row=2, column=1)
    ...
    Radiobutton(
        ...
        height=4,
        width=15,
        command=lambda: voteCast(root, frame1, "Tech council", client_socket),
    ).grid(row=3, column=1)
    ...
    Radiobutton(
        ...
        height=4,
        width=15,
        command=lambda: voteCast(root, frame1, "Code relics", client_socket),
    ).grid(row=4, column=1)
    ...
    Radiobutton(
        ...
        height=4,
        width=15,
        command=lambda: voteCast(root, frame1, "Elitians", client_socket),
    ).grid(row=5, column=1)
