...
def reg_server(root, frame1, name, gender, aadhar, city, passw):
    ...
    elif vid == 1 and len(passw) < 3:
        txt = " !!password is too short (at least 3 characters required)"
        Label(frame1, text=txt, font=("Helvetica", 18, "bold")).grid(
            row=2, column=1, columnspan=2
        )
...
def Register(root, frame1):
    ...
    Label(frame1, text="Register Voter", font=("Helvetica", 18, "bold")).grid(
    ...
    Label(frame1, text="Gender:              ", anchor="e", justify=LEFT).grid(
        row=4, column=0
    )
    Label(frame1, text="Aadhar Number:           ", anchor="e", justify=LEFT).grid(
        row=5, column=0
    )
    Label(frame1, text="City:             ", anchor="e", justify=LEFT).grid(
        row=6, column=0
    )
